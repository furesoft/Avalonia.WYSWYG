...
namespace Avalonia.WYSWYG.Widgets.ProcessChain.Graph.Designer.Layout.ViewModels.Tools;

public partial class ToolboxToolViewModel : ObservableObject, INodeTemplatesHost
{
    ...
    {
        if (e.PropertyName == nameof(Furesoft.LowCode.Designer.Layout.ViewModels.Tools.ToolboxToolViewModel.SearchTerm))
        {
