...
public static class ControlExtensions
{
    ...
    public static void SetColor(this TextBlock textBlock, AdaptiveTextColor color, bool isSubtle,
        AdaptiveRenderContext context)
    {
        var colorOption = context.GetForegroundColors(color);
        var colorCode = isSubtle ? colorOption.Subtle : colorOption.Default;
        textBlock.Foreground = context.GetColorBrush(colorCode);
    }

    public static void SetColor(this Span inlineRun, AdaptiveTextColor color, bool isSubtle,
        AdaptiveRenderContext context)
    {
        var colorOption = context.GetForegroundColors(color);
        var colorCode = isSubtle ? colorOption.Subtle : colorOption.Default;
    ...
    public static void SetColor(this Inline inlineRun, AdaptiveTextColor color, bool isSubtle,
        AdaptiveRenderContext context)
    {
        var colorOption = context.GetForegroundColors(color);
        var colorCode = isSubtle ? colorOption.Subtle : colorOption.Default;
    ...
    public static void SetHighlightColor(this Span inlineRun, AdaptiveTextColor color, bool isSubtle,
        AdaptiveRenderContext context)
    {
        var colorOption = context.GetForegroundColors(color);
        var colorCode = isSubtle ? colorOption.HighlightColors.Subtle : colorOption.HighlightColors.Default;
