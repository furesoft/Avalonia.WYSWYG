...
{
    public static Control RenderSelectAction(this AdaptiveRenderContext context, AdaptiveAction selectAction,
        Control uiElement)
    {
        if (context.Config.SupportsInteractivity)
        {
            ...
            {
                context.Warnings.Add(new(-1, "Inline ShowCard not supported for SelectAction"));
                return uiElement;
            }
            ...
            uiButton.BorderThickness = new(0);
    ...
    public static Control CreateShowCard(this AdaptiveShowCardAction showCardAction, AdaptiveRenderContext context,
        ActionsConfig actionsConfig)
    {
        ...
        uiShowCardContainer.Margin = new(0, actionsConfig.ShowCard.InlineTopMargin, 0, 0);
